...
<table width="210" border="1" class="datatable-side" cellpadding="0" cellspacing="0">
  ...
  <tr>
  <td colspan="2" height="22" >Center No.</td>
  </tr>
  <tr>
    <td colspan="2" style="height: 22px" >Fruit Count</td>
  </tr>
  <tr>
    <td width="45" rowspan="2" ><p class="rowspanned">Off Grade</p></td>
    <td width="165" style="height: 22px">Small Fruit</td>
  </tr>
  <tr>
...
<p class='header'><u>Upload stock photos</u></p>
